...
1️⃣* Перейдите на официальный сайт: 👉* [1win](https://1wlvkt.life/casino/list?open=register&p=16cq)
...
👥 Для получения полного доступа отправьте <a href="https://t.me/chrome_ch?text=Привет!👋 Как получить полный доступ?">администратору</a> сообщение.
    """,
            parse_mode='HTML',
...
def unknown_command(message):
    bot.send_message(message.chat.id, "Я не понимаю эту команду. Используйте кнопки меню или введите /start для перезапуска бота.")
